...
<%@ page  
	import="java.util.List , java.util.HashMap, java.util.Map , com.app.core.*,java.util.Set, java.net.URLEncoder, java.net.URLDecoder , java.util.Iterator  ,javax.servlet.jsp.JspWriter"%>
<%@ page 
	import="java.sql.Connection, com.app.core.CoreMgr , com.app.core.FilesExport , java.util.List , java.util.HashMap , 
	...
	try{
		...
		if (mgr.isInsertAction()){
			...
			if (!mgr.isInsertErrorFlag()){
				...
				response.sendRedirect(request.getRequestURI()+"?myClassBean="+classNameUrl+"&smartyValidationMsg="+encodedRedirectUrl);
				return;
			}
		}
		...
		//System.out.println("executing the finally");
		try{
			conn.close();
		}catch(Exception e){
			/*ignore*/
