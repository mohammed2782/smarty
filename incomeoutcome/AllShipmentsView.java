...
public class AllShipmentsView extends CoreMgr {
	public AllShipmentsView () {
		MainSql ="select stp_name,q_step, c_id 		 , cm_custid     , cm_cust_hp		 , "
				...
				+ " where cm_custid ={customerAcct} order by c_id desc ";
...
//userDefinedGridCols.add("cm_custid");
		...
		userDefinedColLabel.put("cm_custid", "إسم العميل");
