...
public class PickupAgentAllShipmentsViewBarCode extends CoreMgr{
	public PickupAgentAllShipmentsViewBarCode () {
		MainSql ="select stp_name,q_step, c_id 		 , c_custid     , c_custhp		 , "
				...
				+ " where c_pickupagent ={pickupAgentAcctBarCode} order by c_id desc ";
