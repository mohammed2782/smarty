...
public class CustomerUnderProcessShipmentsExcel {
	...
	String ctxPath = "";
	public File getManifestTable(int a_customerId, int a_branchCode, String a_dateRequest, String ctxPath) throws SQLException{		
	String FILE_NAME = "customer_"+a_customerId+"_under_deliveryCases.xls";
	File file = null;
	...
	try {
        ...
        ArrayList<CaseInformation> shipments =  
        		Utilities.getCustomerCasesUnderDelivery(conn, a_customerId, a_dateRequest, a_branchCode);
