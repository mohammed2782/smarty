...
public class PickUpAgentPaymentRecieptPDF {
	...
	class MyFooter extends PdfPageEventHelper {
        ...
        public void onEndPage(PdfWriter writer, Document document) {
            ...
            try {
            	...
            	cb.addImage(image,PageSize.A4.getWidth()-520,0,0,50,40,document.top()+5);
	...
	public void prepareDocument(  int a_transId, String ctxPath) {
		...
		try {
			conn = mysql.getConn();
			papb =  ut.getPickUpAgentPaymentInfo(conn, a_transId);
	       ...
	       // ct.addElement(par);
            ...
            par = new Paragraph(Utilities.getAgentName(conn, papb.getStandardTransactionBean().getEntityId()),font3);
	        cell = new PdfPCell(par);
	        cell.setPadding(5);
 			cell.setBackgroundColor(bc);
 			cell.setVerticalAlignment(Element.ALIGN_LEFT);
            ...
            par = new Paragraph("المبلغ الصافي د.ع:",font2);
	        cell = new PdfPCell(par);
	        cell.setPadding(5);
 			cell.setBackgroundColor(bc);
 			cell.setVerticalAlignment(Element.ALIGN_LEFT);
 			...
 			cell.setBorder(cell.NO_BORDER);
            table.addCell(cell);
            par = new Paragraph(numFormat.format(papb.getStandardTransactionBean().getAmountPaidActuallyIqd()),font3);
	        cell = new PdfPCell(par);
	        cell.setPadding(5);
 			cell.setBackgroundColor(bc);
 			cell.setVerticalAlignment(Element.ALIGN_LEFT);
            ...
            par = new Paragraph("المبلغ الصافي دولار:",font2);
	        cell = new PdfPCell(par);
	        cell.setPadding(5);
 			cell.setBackgroundColor(bc);
 			cell.setVerticalAlignment(Element.ALIGN_LEFT);
            ...
            par = new Paragraph(numFormat.format(papb.getStandardTransactionBean().getAmountPaidActuallyUsd()),font3);
	        cell = new PdfPCell(par);
	        cell.setPadding(5);
 			cell.setBackgroundColor(bc);
 			cell.setVerticalAlignment(Element.ALIGN_LEFT);
	...
	private  PdfPTable getShipmentsTable(Connection conn ,PickUpAgentPaymentBean papb,Font font){
        ...
        try{
			...
			PdfPCell cell;
			int i=1;
            long totNetAmount = 0, totNetAmountUsd=0;
        	...
        	for (CaseInformation ci  : shipments){
				...
				if(ci.getStatus().equalsIgnoreCase("DLV")) {
					if ( ci.getChangedPrice().equalsIgnoreCase("Y")) {
						String s = "تم التسليم مع تغيير سعر الوصل من "+ci.getReceiptAmtB4Change()+", إلى "+ci.getReceiptAmtIqd();
					...
					System.out.println("---->"+ci.getStatus()+" , --->"+ ci.getAdvancedPaymentStatus().equalsIgnoreCase("REFUNDED"));
				}
				cell = new PdfPCell(ph);
				cell.setPaddingBottom(10);
				cell.setBackgroundColor(bc);
			...
			ph = new Phrase(numFormat.format(totNetAmountUsd)+" دولار",fontTotal);
			cell = new PdfPCell(ph);
			cell.setPaddingBottom(10);
			cell.setVerticalAlignment(Element.ALIGN_CENTER);
 			cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			...
			ph = new Phrase(numFormat.format(totNetAmount)+" دينار",fontTotal);
			cell = new PdfPCell(ph);
			cell.setPaddingBottom(10);
			cell.setVerticalAlignment(Element.ALIGN_CENTER);
 			cell.setHorizontalAlignment(Element.ALIGN_CENTER);
