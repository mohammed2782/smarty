...
public class ReturnedItemsListPDF {
	...
	class MyFooter extends PdfPageEventHelper {
        ...
        public void onEndPage(PdfWriter writer, Document document) {
            ...
            try {
            	...
            	cb.addImage(image,PageSize.A4.getWidth()-550,0,0,80,20,document.top()+5);
	...
	public void prepareDocument(  int custId, String ctxPath , int branchCode, String rtnDate) {
