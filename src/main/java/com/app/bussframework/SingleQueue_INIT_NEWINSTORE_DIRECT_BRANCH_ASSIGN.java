...
public class SingleQueue_INIT_NEWINSTORE_DIRECT_BRANCH_ASSIGN extends  SingleQueue_INIT_NEWINSTORE {
	public  SingleQueue_INIT_NEWINSTORE_DIRECT_BRANCH_ASSIGN() {
...
//		userDefinedGridCols.add("c_qty");
		...
		userDefinedCaption = "أسناد مباشر للفروع";
	...
	public void initialize(HashMap smartyStateMap) {
		...
		userDefinedCaption = "<div class='row'><div class='col-md-2 col-sm-2 col-xs-2'>" + this.userDefinedCaption + "</div>"
		...
		+ "</div>"
		+ " <div class='col-md-3 col-sm-12 col-xs-12'>أختيار مندوب ارتباط للكل "+DropDownHtml+" </div></div>";
	}
	@Override
