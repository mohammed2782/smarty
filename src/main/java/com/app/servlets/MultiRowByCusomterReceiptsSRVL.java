...
/**
 * Servlet implementation class MultiRowByCusomterReceiptsSRVL
 */
@WebServlet("/MultiRowByCusomterReceiptsSRVL")
public class MultiRowByCusomterReceiptsSRVL extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MultiRowByCusomterReceiptsSRVL() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		NewCasesByCustomer ncbc = new NewCasesByCustomer();		
