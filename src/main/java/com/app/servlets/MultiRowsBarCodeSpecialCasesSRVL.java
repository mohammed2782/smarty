...
import com.app.cases.NewSpecialCasesBarcode;

import smarty.security.LoginUser;

/**
 * Servlet implementation class MultiRowsBarCodeSpecialCasesSRVL
 */
@WebServlet("/MultiRowsBarCodeSpecialCasesSRVL")
public class MultiRowsBarCodeSpecialCasesSRVL extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MultiRowsBarCodeSpecialCasesSRVL() {
        super();
