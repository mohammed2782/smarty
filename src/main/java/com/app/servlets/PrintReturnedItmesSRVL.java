...
import com.app.printables.ReturnedItemsListPDF;
 ...
 */
@WebServlet("/PrintReturnedItmesSRVL")
public class PrintReturnedItmesSRVL extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrintReturnedItmesSRVL() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			File file = getFileExported (pdfRs, cust_id , branchCode , ctxPath, rtndate);
		...
		public File getFileExported(ReturnedItemsListPDF pdfRs , int custId, int branchCode, String ctxPath, String rtndate){
