...
import com.app.cases.NewCasesOldSystem;
...
/**
 * Servlet implementation class MultiRowOldReceiptsSRVL
 */
@WebServlet("/MultiRowOldReceiptsSRVL")
public class MultiRowOldReceiptsSRVL extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MultiRowOldReceiptsSRVL() {
        super();
