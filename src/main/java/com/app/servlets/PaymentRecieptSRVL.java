...
import com.app.printables.PaymentRecieptPDF;
 ...
 */
@WebServlet("/PaymentReceiptSRVL")
public class PaymentRecieptSRVL extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PaymentRecieptSRVL() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String fileName = "paymentreciept_"+transId+"_.pdf"; 
			...
			File file = getFileExported (pdfRs, transId , ctxPath);
		...
		public File getFileExported(PaymentRecieptPDF a_pdfRs , int a_transId, String a_ctxPath){
		// move the file to be input stream.
		a_pdfRs.prepareDocument (a_transId, a_ctxPath);
