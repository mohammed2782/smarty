...
public class BranchManifestReturn extends CoreMgr{
	public BranchManifestReturn() {
		...
		+ " from p_rtnliaisonagent_manifest where rlam_tobranch={branchAccountReturnProcess} "
		+ " and rlam_deleted='N' and rlam_frombranch = {userstorecode} "
		...
		// //////////////
		userDefinedCaption = "ارشيف منفيستات الرواجع المستلمة من الفروع";
