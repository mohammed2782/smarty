...
public class UpdateCasesConditionControl extends CoreMgr{
	public UpdateCasesConditionControl() {
	MainSql = "select * from kbgeneral where kbcat1='CASES'";
	//canNew = true;
	//canDelete = true;
	...
	userDefinedColLabel.put("kbcat4", "Catigory4");
