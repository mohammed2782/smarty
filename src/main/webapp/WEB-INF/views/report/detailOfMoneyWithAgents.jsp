...
<%@ page import="com.app.reports.DetailOfMoneyWithAgents" %>
<%   
...
DetailOfMoneyWithAgents detailOfMoneyWithAgents = new DetailOfMoneyWithAgents(); 
Render(detailOfMoneyWithAgents  , out , request, response , Myglobals , objectState , pageName1);
%> 
<script>
