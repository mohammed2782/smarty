...
<%@ page import="com.app.reports.DetailOfTobePaidToCustomers" %>
<%   
...
DetailOfTobePaidToCustomers detailOfTobePaidToCustomers = new DetailOfTobePaidToCustomers(); 
Render(detailOfTobePaidToCustomers  , out , request, response , Myglobals , objectState , pageName1);
%> 
<script>
