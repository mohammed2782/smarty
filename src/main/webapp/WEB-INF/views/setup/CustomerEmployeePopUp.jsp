...
<%  
String masterCustIdLogin = (String)request.getParameter("mastercustidlogin");

if (masterCustIdLogin !=null){
	Myglobals.smartyGlobalsAssArr.put("mastercustidlogin", (String)masterCustIdLogin);
}else if (Myglobals.smartyGlobalsAssArr.containsKey("mastercustidlogin") && Myglobals.smartyGlobalsAssArr.get("mastercustidlogin")!=null){
	masterCustIdLogin = (String)Myglobals.smartyGlobalsAssArr.get("mastercustidlogin");
}
