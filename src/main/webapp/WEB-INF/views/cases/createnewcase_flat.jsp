...
<%@ page import="com.app.cases.NewCasesFlat" %> 
<%@ page import="com.app.util.Utilities,java.sql.PreparedStatement,java.sql.ResultSet" %>
<%

 	String pageName1 = this.getClass().getPackage().getName()+"."+this.getClass().getSimpleName();
	NewCasesFlat newCasesFlat = new NewCasesFlat(); 
 	Render(newCasesFlat  , out , request, response , Myglobals , objectState , pageName1); 
...
$(document).ready(function() {
	$('#add_rcv_dtls').click(function(){
		...
		$.get('../../MultiRowsFlatSRVL?state='+state+'&loadRcvRow='+RCVno , dataToSend,function(data, status){ 
			if (status=='success'){
...
function disableF5(e) {
	...
	$(document).ready(function(){
		var link = document.getElementById('dummy_label');
		link.style.display = 'none'; //or
		var link = document.getElementById('dummy');
		link.style.display = 'none'; //or
