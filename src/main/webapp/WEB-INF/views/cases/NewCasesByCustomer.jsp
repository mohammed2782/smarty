...
<%@ page import="com.app.cases.NewCasesByCustomer" %> 
...
NewCasesByCustomer nc = new NewCasesByCustomer(); 
...
$('#add_rcv_dtls').click(function(){ 
	...
	$.get('../../MultiRowByCusomterReceiptsSRVL?loadRcvRow='+RCVno , dataToSend)
	.done(
...
function disableF1(e) {
	  if ((e.which || e.keyCode) == 112){
		  e.preventDefault();
		  document.getElementById('save_new_form_com_dot_app_dot_cases_dot_NewCasesByCustomer').click();
	  }
};
