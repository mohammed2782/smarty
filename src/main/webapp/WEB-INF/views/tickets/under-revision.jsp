...
if (load != null) {
	Myglobals.smartyGlobalsAssArr.put("my_tab_load_under_review", (String) load);
} else if (Myglobals.smartyGlobalsAssArr.containsKey("my_tab_load_under_review")
		&& Myglobals.smartyGlobalsAssArr.get("my_tab_load_under_review") != null) {
	load = (String) Myglobals.smartyGlobalsAssArr.get("my_tab_load_under_review");
}
if (load!=null && load.equalsIgnoreCase("doLoad")){
	String pageName1 = this.getClass().getPackage().getName()+"."+this.getClass().getSimpleName();
	CasesFollowUp casesFollowUp = new CasesFollowUp();
	Render(casesFollowUp  , out , request, response , Myglobals , objectState , pageName1);
}
%>
