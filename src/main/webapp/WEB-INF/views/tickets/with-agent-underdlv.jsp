...
if (load != null) {
	Myglobals.smartyGlobalsAssArr.put("my_tab_load_underdlv", (String) load);
} else if (Myglobals.smartyGlobalsAssArr.containsKey("my_tab_load_underdlv")
		&& Myglobals.smartyGlobalsAssArr.get("my_tab_load_underdlv") != null) {
	load = (String) Myglobals.smartyGlobalsAssArr.get("my_tab_load_underdlv");
}
if (load!=null && load.equalsIgnoreCase("doLoad")){
	String pageName1 = this.getClass().getPackage().getName()+"."+this.getClass().getSimpleName();
 	SingleQueue_AGENTOP_WITH_AGENT singleQueue_AGENTOP_WITH_AGENT = new SingleQueue_AGENTOP_WITH_AGENT();
	Render(singleQueue_AGENTOP_WITH_AGENT  , out , request, response , Myglobals , objectState , pageName1);
}
%>
