...
if (load != null) {
	Myglobals.smartyGlobalsAssArr.put("my_tab_load_reviewed", (String) load);
} else if (Myglobals.smartyGlobalsAssArr.containsKey("my_tab_load_reviewed")
		&& Myglobals.smartyGlobalsAssArr.get("my_tab_load_reviewed") != null) {
	load = (String) Myglobals.smartyGlobalsAssArr.get("my_tab_load_reviewed");
}
if (load!=null && load.equalsIgnoreCase("doLoad")){
	...
	SingleQueue_AGENTOP_FollowedUp singleQueue_AGENTOP_FollowedUp = new SingleQueue_AGENTOP_FollowedUp();
	singleQueue_AGENTOP_FollowedUp.setStepsAndActions(stepsAndActions);
	Render(singleQueue_AGENTOP_FollowedUp, out , request, response , Myglobals , objectState , pageName1);
}
%>
