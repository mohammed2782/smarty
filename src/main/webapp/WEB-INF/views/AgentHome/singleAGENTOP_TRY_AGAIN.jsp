...
<%	
Myglobals.smartyGlobalsAssArr.put("stp_code", (String)"TRY_AGAIN");
 	String pageName1 = this.getClass().getPackage().getName()+"."+this.getClass().getSimpleName();
	SingleAGENTOP_ALLOPS sata = new SingleAGENTOP_ALLOPS();
 	Render(sata  , out , request, response , Myglobals , objectState , pageName1); 
%> 
