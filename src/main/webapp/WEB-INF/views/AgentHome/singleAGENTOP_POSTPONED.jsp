...
<%	
Myglobals.smartyGlobalsAssArr.put("stp_code", (String)"POSTPONED");
 	String pageName1 = this.getClass().getPackage().getName()+"."+this.getClass().getSimpleName();
SingleAGENTOP_ALLOPS sap = new SingleAGENTOP_ALLOPS();
 	Render(sap  , out , request, response , Myglobals , objectState , pageName1); 
%> 
